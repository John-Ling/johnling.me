...
_My laptop used to use an MPE-1800AX WiFi card however any newer version of Coreboot just didn't work with it. If you know you have this WiFi card, you might want to consider using (my config)[https://github.com/John-Ling/coreboot-rom] as it's guaranteed to work._
