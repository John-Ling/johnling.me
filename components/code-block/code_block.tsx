...
export default function CodeBlock({ language = "plaintext", filename = "", canCopy = true, children }: CodeBlockProps) {
		...
		<div className="bg-[#161616] border-2 border-grey-light flex flex-col mb-5 mt-5">
			...
			<div className="flex flex-row">
				...
				<pre className="bg-[#161616] pl-2 w-full overflow-y-hidden m-0">
					<code className="hljs" dangerouslySetInnerHTML={{ __html: hljs.highlight(cleanCode, { language }).value }} />
				</pre>
			</div>
		</div>
	);
