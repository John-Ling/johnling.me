import SkillsDisplay from "../home/homepage-sections/what-section/skills_display";
    ...
    <section className="min-h-screen flex flex-col items-center lg:flex-row p-5 gap-10 lg:w-3/4">
      ...
      > 
        ...
        <p className="mb-5">
          ...
          languages for one-off projects such as C++ or Java. 
        </p>
        <p className="mb-5">
          However I would definitely say I&apos;m 
