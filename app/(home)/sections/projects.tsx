...
export default function Projects() {
  ...
  return (
    <>
      ...
      <motion.section className='h-4/5 flex flex-col mx-auto max-w-[1920px] w-11/12 lg:w-11/12 2xl:w-9/12 mt-10 mb-10  z-30'>
        <h2 className='text-4xl mb-3 mt-3 font-bold font-serif text-center lg:text-left'>
