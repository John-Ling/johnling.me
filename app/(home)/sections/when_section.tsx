  ...
  return (
    <section className='min-h-screen flex flex-col items-center justify-center md:gap-10 lg:flex-row px-5 sm:px-6 lg:px-13 xl:px-25 lg:w-10/12 max-w[1920px] mx-auto'>
      ...
      <div className='hidden lg:basis-1/2 md:grid grid-cols-2 gap-8'>
        <div
          className='when-section-picture mr-10 opacity-0 max-w-80'
        ...
        <div className='when-section-picture opacity-0 w-52' style={{ animationDelay: '400ms' }}>
          <div className=''>
            <Image
              className='animate-float-inverse'
        ...
        <div
          className='when-section-picture opacity-0 max-w-64'
          style={{ animationDelay: '300ms' }}
        >
          <div className='translate-x-12'>
            <Image
              loading='eager'
              className='animate-float-inverse w-80'
              src={server}
        ...
        <div
          className='when-section-picture opacity-0  col-start-2 w-72'
          style={{ animationDelay: '400ms' }}
        >
          <div className=''>
            <Image
