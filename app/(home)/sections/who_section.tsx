...
const WhoSection = () => {
  return (
    <section className='min-h-screen flex flex-col justify-center mx-auto items-center lg:flex-row mt-5 lg:mt-0 gap-10 px-5 sm:px-6 lg:px-13 xl:px-25  lg:w-10/12'>
