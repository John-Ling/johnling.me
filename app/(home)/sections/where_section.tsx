...
const WhereSection = () => {
  return (
    <section
      className='min-h-screen flex flex-col lg:w-11/12 xl:w-3/4 justify-center items-center'
      id='contact'
    >
      <h2
        ...
        <div className='flex flex-row justify-center lg:justify-start'>
          <div className='transition-all hover:-translate-y-1'>
            <a
              ...
              className='opacity-0 trigger-fade-on-scroll p-2 no-underline hover:text-orange icon-link'
      ...
      <div className='opacity-0 trigger-fade-on-scroll' style={{ animationDelay: "300ms" }}>
        <h4
          className='opacity-0 trigger-fade-on-scroll text-2xl font-bold mb-4'
          style={{ animationDelay: "400ms" }}
        >
          Leave me a Message
        </h4>
        <Link
          className='link opacity-0 trigger-fade-on-scroll'
