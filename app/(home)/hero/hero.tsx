...
export default function Hero() {
	...
	return (
		<motion.div variants={container} initial="hidden" animate="show">
			<div className="lg:h-[75vh] mx-auto w-11/12 lg:w-10/12 2xl:w-8/12 mt-10 mb-10 lg:mb-0 flex items-center ">
				<div className="flex flex-col lg:w-1/2 mx-auto z-20 lg:-translate-y-20">
