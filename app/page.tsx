      ...
      <div className="flex flex-col m-auto lg:w-3/4 ">
        ...
        <section className="min-h-screen flex flex-col items-center lg:flex-row p-5 gap-x-10 gap-y-10">
          ...
          <div className="order-1 lg:w-1/2">
            ...
            <p className="mb-5">I don&apos;t exactly subscribe to a particular &quot;Tech Stack&quot;. I believe limiting yourself to only the latest and greatest is limiting and promotes tribalism.</p>
